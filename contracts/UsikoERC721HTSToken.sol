 ...
 * - Royalty: _royalty% with 1 HBAR fallback to initialOwner.
 */
contract UsikoERC721HTSToken is HederaTokenService, KeyHelper, Ownable {
    ...
    function transferNft(uint256 tokenId, address receiver) external {
        require(tokenAddress != address(0), "HTS: not created");
        ...
        IERC721(tokenAddress).transferFrom(owner_, receiver, tokenId);
    }
